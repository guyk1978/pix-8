export const en = {
  ...
  editor: {
    ...
    upload: {
      ...
      hint: "Drop an image to start your layer-based workflow. All processing stays in your browser.",
    },
    ...
    params: {
      ...
      advancedEdges: "Advanced Edges",
      subjectMasking: "Subject Masking",
    ...
    workspace: {
      ...
      switched: "Switched image — layer stack reset to original.",
    },
    favorite: {
      defaultName: "Editor workspace",
      saved: "Workspace added to favorites.",
