export const en = {
  ...
  editor: {
    ...
    layers: {
      ...
      empty: "Upload an image to start building your layer stack.",
      source: "Original Image",
      bgRemove: "AI Background Removed",
      resize: "Resized",
      crop: "Cropped",
      transform: "Rotated / Flipped",
      colorAdjust: "Color Adjusted",
      ...
      customCut: "Custom Cut",
      magnifier: "Magnifier View",
      palette: "Palette Extract",
      colorPicker: "Color Picker",
      cssPalette: "CSS Palette",
      annotator: "Annotation",
      exportSvg: "SVG Export",
      exportFavicon: "Favicon Export",
      exportBase64: "Base64 Export",
      show: "Show layer",
      hide: "Hide layer",
      lock: "Lock layer",
      unlock: "Unlock layer",
    ...
    params: {
      title: "Parameters",
      empty: "Select a layer to edit its parameters.",
      bgRemoveEnabled: "Remove background",
      maskRefinement: "Mask Refinement",
      refineEdge: "Refine Edge",
      decontaminateColor: "Decontaminate Color",
      smartMaskingStrength: "Smart Masking Strength",
      smartHandRecognition: "Smart Hand Recognition",
      maskRefinementHint:
        "Refines hair edges, removes sky glow, and preserves hand detail after AI removal.",
      maskBrushTools: "Mask Brush Tools",
      maskBrushAdd: "Add to mask",
      maskBrushRemove: "Remove from mask",
      maskBrushFeather: "Feather edge",
      maskBrushComingSoon: "Manual brush refinement — coming soon.",
      maskBrushHint: "Select a brush, then paint on the image to refine the mask.",
      maskBrushActive: "Brush active — paint on the image to refine edges.",
      maskBrushWaiting: "Wait for AI background removal to finish before brushing.",
      maskBrushClean: "Wide clean brush",
      maskBrushCleanActive:
        "Smart clean brush — erases background-colored pixels only. Paint smoothly over leftover chunks.",
      maskBrushCleanSize: "Clean brush width",
      maskBrushSize: "Brush width",
      maskClickTools: "Click mask correction (SAM)",
      maskClickAdd: "Click to add missing area",
      maskClickRemove: "Click to remove area",
      maskClickHint:
        "Click on a missing hand, strap, or edge. MobileSAM runs locally on first use (~43 MB download).",
      maskClickActive: "Click mode active — tap the area to re-segment at high precision.",
      maskClickLoading: "Preparing local SAM…",
      maskClickTitle: "Mask correction",
      maskClickFailed: "Click segmentation failed. Check your connection for the first model download.",
      maskAnalysisTitle: "Detail analysis",
      maskAnalysisHair: "Hair edges",
      maskAnalysisHairHint: "Use Refine Edge + Decontaminate Color for glow and blending.",
      maskAnalysisHand: "Hands",
      maskAnalysisHandHint: "Raise Smart Masking Strength and enable Smart Hand Recognition.",
      maskAnalysisStrap: "Thin edges",
      maskAnalysisStrapHint: "Refine Edge sharpens straps, bag edges, and fine silhouettes.",
      advancedEdges: "Refine Edge",
      subjectMasking: "Smart Masking Strength",
      depthEstimation: "Decontaminate Color",
      width: "Width",
      height: "Height",
      cropX: "Crop X",
      cropY: "Crop Y",
      ...
      compressExportBaseline: "Uncompressed export (PNG)",
      stripMetadata: "Strip metadata on export",
      intensity: "Intensity",
      strength: "Strength",
      borderWidth: "Border width",
      borderColor: "Border color",
      cornerRadius: "Corner radius",
      invertEnabled: "Invert colors",
      lensCorrection: "Lens correction",
      textColor: "Text color",
      overlayScale: "Overlay scale",
      memeTop: "Top text",
      memeBottom: "Bottom text",
      zoom: "Zoom",
      annotatorLabel: "Label",
      colorCount: "Color count",
      copied: "Copied",
      copyBase64: "Copy Base64 to clipboard",
      base64Copied: "Base64 copied to clipboard",
      exportSvgHint: "Tracing runs on layers above this one. Adjust settings to regenerate.",
      svgCopied: "SVG copied to clipboard",
      downloadFavicon: "Download favicon",
      cutKeep: "Keep selection",
      cutRemove: "Remove selection",
      collageIncludeSource: "Include current image",
      collageAddImages: "Add photos",
      collageRemoveImage: "Remove",
      collageImageCount: "{count} images in collage",
      collageAddFromWorkspace: "Add {count} from workspace",
      collageAddedFromWorkspaceOne: "Workspace image added to collage.",
      collageAddedFromWorkspaceMany: "{count} workspace images added to collage.",
      collageNoWorkspaceImages: "No new workspace images to add.",
      bgReplaceUpload: "Upload replacement background",
      bgReplaceFromWorkspace: "Use active workspace image",
    },
    bottomBar: {
      undo: "Undo",
      redo: "Redo",
    ...
    workspace: {
      ...
      addAria: "Add image to workspace",
      imageAria: "Workspace image {number}: {name}",
      addedOne: "Image added to workspace.",
      addedMany: "{count} images added to workspace.",
      switched: "Switched image — your edits for this photo were restored.",
      removeAria: "Remove {name} from session",
      removed: "Image removed from session.",
      cannotRemoveLast: "Keep at least one image in the session.",
    },
    favorite: {
      defaultName: "Editor workspace",
      saved: "Workspace saved locally.",
      removed: "Workspace removed from quick save.",
      saveFailed: "Could not save workspace.",
    },
    status: {
      issue: "Issue",
      monitor: "Support / AI Monitor",
    },
    toolUnavailable: "This tool is not available in the unified editor yet.",
  },
  toolCategoryPages: {
  ...
  upload: {
    ...
    noImageTryThese: "Don't have an image? Use one of the examples below:",
    ...
    exampleCarouselPrev: "Previous examples",
    exampleCarouselNext: "More examples",
  ...
  ecosystem: {
    openJoinMyPdf: "Open JoinMyPDF",
    convertToPdf: "Convert to PDF in JoinMyPDF",
    signInJoinMyPdf: "Sign document in JoinMyPDF",
    addToJoinMyPdf: "Add to JoinMyPDF merge",
    sendPngToPdf: "Send as PNG → PDF",
    sendToJoinMyPdf: "Send to JoinMyPDF",
  ...
  toolUi: {
    ...
    bgRemover: {
      ...
      subjectOpacity: "Subject opacity",
      colorPresets: "Color presets",
      gradientPresets: "Gradient presets",
      exampleBackgrounds: "Example backgrounds",
      presets: {
        white: "White",
        ...
        dark: "Dark",
        gradientSky: "Sky gradient",
        gradientSunset: "Sunset gradient",
        gradientOcean: "Ocean gradient",
        gradientForest: "Forest gradient",
        gradientPurple: "Purple haze",
