export const en = {
  ...
  header: {
    ...
    openApps: "Browse tools and categories",
    closeApps: "Close tools menu",
  ...
  home: {
    ...
    collapseControls: "Focus on image",
  ...
  workspaceQueue: {
    toolbarLabel: "Workspace images",
    addImage: "Add image",
    addImagesAria: "Add more images",
    imageLabel: "Image {index}: {name}",
  },
  embeddedToolbar: {
  ...
  upload: {
    ...
    compactHeadline: "Upload an image to get started",
    compactHeadlineWithTool: "Upload an image to use {tool}",
    uploadButton: "Upload image",
    orDropFile: "or drop a file",
    noImageTryThese: "No image? Try one of these:",
  ...
  watermark: {
    ...
    chooseWatermark: "Choose watermark",
    dropWatermarkHint: "or drag a watermark image here",
  ...
  toolUi: {
    ...
    bgRemover: {
      uploadHeadline: "Upload an image to remove the background",
