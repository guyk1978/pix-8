...
import { BackgroundRemoverLandingRelatedUseCases } from "@/components/landing/BackgroundRemoverLandingRelatedUseCases";
import {
...
import {
  ...
  getBackgroundRemoverLandingEntry,
} from "@/lib/backgroundRemoverLandingsLocale";
import { Shield, Sparkles, Zap, Layers, BadgeCheck, Eraser, ShoppingBag, Megaphone, Share2, Camera, Cpu, Globe, CloudOff, Lock, type LucideIcon } from "lucide-react";
...
> = {
  "remove-background-from-image-online": [Shield, Zap, Sparkles],
  "transparent-background-maker": [Shield, Zap, Layers],
  "remove-image-background-free": [Shield, Zap, BadgeCheck],
  "erase-background-online": [Shield, Zap, Eraser],
  "background-remover-for-ecommerce": [Shield, Zap, ShoppingBag],
  "remove-background-for-marketing-graphics": [Shield, Zap, Megaphone],
  "background-eraser-for-social-media-photos": [Shield, Zap, Share2],
  "professional-background-removal-for-photographers": [Shield, Zap, Camera],
  "client-side-background-remover": [Shield, Zap, Cpu],
  "browser-based-background-eraser": [Shield, Zap, Globe],
  "no-upload-image-background-remover": [Shield, Zap, CloudOff],
  "privacy-first-background-removal-tool": [Shield, Zap, Lock],
};

interface BackgroundRemoverLandingViewProps {
  landingId: BackgroundRemoverLandingId;
}

export function BackgroundRemoverLandingView({
  landingId,
}: BackgroundRemoverLandingViewProps) {
  ...
  const accent = BACKGROUND_REMOVER_LANDING_ACCENT;
  ...
  return (
    ...
    >
      <section className="mb-14 sm:mb-16">
        ...
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] lg:items-end">
          <div className="max-w-2xl space-y-5">
            ...
            >
              <LandingCtaButton href={BACKGROUND_REMOVER_TOOL_HREF} accent={accent}>
                {landing.primaryCta}
              </LandingCtaButton>
      ...
      <BackgroundRemoverLandingRelatedUseCases currentLandingId={landingId} />
