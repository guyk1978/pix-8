...
import {
  ...
  getRelatedRotateFlipLandingPages,
...
interface RotateFlipLandingRelatedUseCasesProps {
  currentLandingId: RotateFlipLandingId;
}

export function RotateFlipLandingRelatedUseCases({
  currentLandingId,
}: RotateFlipLandingRelatedUseCasesProps) {
  const { language } = useLanguage();
  const relatedPages = getRelatedRotateFlipLandingPages(
    currentLandingId,
    language,
  );
                ...
                <li key={page.path}>
                  <AppLink href={page.path} className={linkCardClassName}>
                    <h3
                      ...
                      style={{ color: ROTATE_FLIP_LANDING_ACCENT }}
                    >
                      {page.linkTitle}
                    </h3>
