...
interface LandingRelatedUseCasesProps {
  currentLandingId: ImageAnnotatorLandingId;
}

export function LandingRelatedUseCases({
  currentLandingId,
}: LandingRelatedUseCasesProps) {
  const { language } = useLanguage();
  const relatedPages = getRelatedLandingPages(currentLandingId, language);
