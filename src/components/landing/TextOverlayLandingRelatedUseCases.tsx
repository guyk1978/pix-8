...
import {
  ...
  getRelatedTextOverlayLandingPages,
...
interface TextOverlayLandingRelatedUseCasesProps {
  currentLandingId: TextOverlayLandingId;
}

export function TextOverlayLandingRelatedUseCases({
  currentLandingId,
}: TextOverlayLandingRelatedUseCasesProps) {
  const { language } = useLanguage();
  const relatedPages = getRelatedTextOverlayLandingPages(
    currentLandingId,
    language,
  );
                ...
                <li key={page.path}>
                  <AppLink href={page.path} className={linkCardClassName}>
                    <h3
                      ...
                      style={{ color: TEXT_OVERLAY_LANDING_ACCENT }}
                    >
                      {page.linkTitle}
                    </h3>
