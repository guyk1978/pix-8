...
import { CustomCutterLandingRelatedUseCases } from "@/components/landing/CustomCutterLandingRelatedUseCases";
import {
...
import {
  ...
  getCustomCutterLandingEntry,
} from "@/lib/customCutterLandingsLocale";
import { Aperture, BadgeCheck, CloudOff, Cpu, Crosshair, Monitor, Move, Palette, Ruler, Scissors, Shield, Sparkles, SquareDashed, Zap, type LucideIcon } from "lucide-react";
import type { CSSProperties } from "react";

const DEFAULT_BENEFIT_ICONS = [Shield, Zap, Sparkles] as const;

const LANDING_BENEFIT_ICONS: Partial<
  Record<CustomCutterLandingId, readonly [LucideIcon, LucideIcon, LucideIcon]>
> = {
  "custom-image-cutter": [Shield, Zap, SquareDashed],
  "freeform-image-cropping": [Shield, Zap, Move],
  "cut-out-shapes-from-images": [Shield, Zap, Scissors],
  "custom-shape-photo-cutter": [Shield, Zap, Aperture],
  "precision-image-cutter-tool": [Shield, Zap, Crosshair],
  "client-side-custom-image-cutter": [Shield, Zap, Cpu],
  "browser-based-custom-cropper": [Shield, Zap, Monitor],
  "no-upload-custom-shape-cutter": [Shield, Zap, CloudOff],
  "cut-image-to-custom-size": [Shield, Zap, Ruler],
  "custom-crop-for-digital-design": [Shield, Zap, Palette],
  "easy-custom-photo-cutter": [Shield, Zap, BadgeCheck],
  "creative-image-cutting-tool": [Shield, Zap, Sparkles],
};

interface CustomCutterLandingViewProps {
  landingId: CustomCutterLandingId;
}

export function CustomCutterLandingView({
  landingId,
}: CustomCutterLandingViewProps) {
  ...
  const accent = CUSTOM_CUTTER_LANDING_ACCENT;
  ...
  return (
    ...
    >
      <section className="mb-14 sm:mb-16">
        ...
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] lg:items-end">
          <div className="max-w-2xl space-y-5">
            ...
            >
              <LandingCtaButton href={CUSTOM_CUTTER_TOOL_HREF} accent={accent}>
                {landing.primaryCta}
              </LandingCtaButton>
      ...
      <CustomCutterLandingRelatedUseCases currentLandingId={landingId} />
