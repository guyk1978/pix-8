...
import {
  ...
  getRelatedMemeGeneratorLandingPages,
...
interface MemeGeneratorLandingRelatedUseCasesProps {
  currentLandingId: MemeGeneratorLandingId;
}

export function MemeGeneratorLandingRelatedUseCases({
  currentLandingId,
}: MemeGeneratorLandingRelatedUseCasesProps) {
  const { language } = useLanguage();
  const relatedPages = getRelatedMemeGeneratorLandingPages(
    currentLandingId,
    language,
  );
                ...
                <li key={page.path}>
                  <AppLink href={page.path} className={linkCardClassName}>
                    <h3
                      ...
                      style={{ color: MEME_GENERATOR_LANDING_ACCENT }}
                    >
                      {page.linkTitle}
                    </h3>
