...
import { LandingRelatedUseCases } from "@/components/landing/LandingRelatedUseCases";
import {
...
import {
  getImageAnnotatorLandingChrome,
...
> = {
  "annotate-images-online-free": [Shield, Zap, MapPin],
  "draw-arrows-on-images-online": [Shield, Zap, MousePointerClick],
  "add-text-to-image-online": [Shield, Zap, Type],
  "highlight-part-of-image-online": [Shield, Zap, Focus],
  "image-annotator-for-web-developers": [Shield, Zap, Code2],
  "annotate-images-for-documentation": [Shield, Zap, BookOpen],
  "image-markup-for-remote-teams": [Shield, Zap, Globe],
  "screenshot-annotation-tool-for-designers": [Shield, Zap, Palette],
  "fast-image-editor-for-marketing-teams": [Shield, Zap, Megaphone],
  "browser-based-image-annotator": [Shield, Zap, Monitor],
  "client-side-image-editor": [Shield, Zap, HardDrive],
  "privacy-focused-image-editor": [Shield, Zap, Lock],
  "no-install-image-annotation-tool": [Shield, Zap, AppWindow],
  "lightweight-image-markup-tool": [Shield, Zap, Feather],
};

interface ImageAnnotatorLandingViewProps {
  landingId: ImageAnnotatorLandingId;
}

export function ImageAnnotatorLandingView({
  landingId,
}: ImageAnnotatorLandingViewProps) {
  const { language, dir } = useLanguage();
  const landing = getImageAnnotatorLandings(language)[landingId];
  const chrome = getImageAnnotatorLandingChrome(language);
  const benefitIcons = LANDING_BENEFIT_ICONS[landingId];
  ...
  return (
    <div
      ...
      style={{ "--landing-accent": LANDING_ACCENT } as CSSProperties}
    >
      <section className="mb-14 sm:mb-16">
        ...
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] lg:items-end">
          <div className="max-w-2xl space-y-5">
            ...
            >
              <LandingCtaButton>{landing.primaryCta}</LandingCtaButton>
          ...
          <div className="rounded-sm border border-border bg-card p-5 sm:p-6">
            ...
            <LandingCapabilitiesList capabilities={landing.capabilities} />
          </div>
        </div>
      </section>
      ...
      <LandingRelatedUseCases currentLandingId={landingId} />
      ...
      <section className="rounded-sm border border-border bg-card p-6 text-center sm:p-8">
        ...
        <div className="mt-6 flex flex-col items-center gap-3">
          <LandingCtaButton>{landing.closingCta.button}</LandingCtaButton>
