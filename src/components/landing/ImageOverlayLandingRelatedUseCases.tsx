...
import {
  ...
  getRelatedImageOverlayLandingPages,
...
interface ImageOverlayLandingRelatedUseCasesProps {
  currentLandingId: ImageOverlayLandingId;
}

export function ImageOverlayLandingRelatedUseCases({
  currentLandingId,
}: ImageOverlayLandingRelatedUseCasesProps) {
  const { language } = useLanguage();
  const relatedPages = getRelatedImageOverlayLandingPages(
    currentLandingId,
    language,
  );
                ...
                <li key={page.path}>
                  <AppLink href={page.path} className={linkCardClassName}>
                    <h3
                      ...
                      style={{ color: IMAGE_OVERLAY_LANDING_ACCENT }}
                    >
                      {page.linkTitle}
                    </h3>
